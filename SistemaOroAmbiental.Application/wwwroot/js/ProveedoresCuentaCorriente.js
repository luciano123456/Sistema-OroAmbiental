...
const columnConfigProvCC = [
    ...
    { index: 3, filterType: 'select', fetchDataFunc: listaTiposMovFilterProvCC },
...
registrarFiltrosGrilla('grd_ProveedorCC', columnConfigProvCC, {
    includeActivo: false,
...
`;
            ...
            initComplete: async function () {
                const api = this.api();
                await armarFiltrosGrillaLista(api, '#grd_ProveedorCC', columnConfigProvCC, {
                    includeActivo: false,
                    panelTitle: 'Filtrar resultados cargados',
                    initSelect2: ($el) => ensureSelect2($el, { dropdownParent: $(document.body), minimumResultsForSearch: 0, allowClear: true, placeholder: 'Todos' })
                });
